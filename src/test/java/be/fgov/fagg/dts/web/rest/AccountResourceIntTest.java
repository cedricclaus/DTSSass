package be.fgov.fagg.dts.web.rest;

import be.fgov.fagg.dts.config.Constants;
import be.fgov.fagg.dts.DtsSassApp;
import be.fgov.fagg.dts.domain.Authority;
import be.fgov.fagg.dts.domain.User;
import be.fgov.fagg.dts.repository.AuthorityRepository;
import be.fgov.fagg.dts.repository.UserRepository;
import be.fgov.fagg.dts.security.AuthoritiesConstants;
import be.fgov.fagg.dts.service.MailService;
import be.fgov.fagg.dts.service.dto.UserDTO;
import be.fgov.fagg.dts.web.rest.errors.ExceptionTranslator;
import be.fgov.fagg.dts.web.rest.vm.KeyAndPasswordVM;
import be.fgov.fagg.dts.web.rest.vm.ManagedUserVM;
import be.fgov.fagg.dts.service.UserService;
...
@SpringBootTest(classes = DtsSassApp.class)
