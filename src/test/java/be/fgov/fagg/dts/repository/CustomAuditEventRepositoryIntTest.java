package be.fgov.fagg.dts.repository;

import be.fgov.fagg.dts.DtsSassApp;
import be.fgov.fagg.dts.config.Constants;
import be.fgov.fagg.dts.config.audit.AuditEventConverter;
import be.fgov.fagg.dts.domain.PersistentAuditEvent;
...
import static be.fgov.fagg.dts.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
